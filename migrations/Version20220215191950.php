 ...
 */
final class Version20220215191950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD genre_id INT DEFAULT NULL, DROP id_book');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book_genre (book_id INT NOT NULL, genre_id INT NOT NULL, INDEX IDX_8D9226814296D31F (genre_id), INDEX IDX_8D92268116A2B381 (book_id), PRIMARY KEY(book_id, genre_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE book ADD id_book INT NOT NULL, DROP genre_id');
    }
}
